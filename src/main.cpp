...
public:
    bool keyDown = false;
    TempEventHandler() {}
    virtual void onKeyDown(uint keyCode, bool isRepeat)
    {
        keyDown=true;
    }
...
//	drawParams.destBlend = RenderDevice::BLEND_FUNC_ONE;
	...
	TempEventHandler tempEventHandler;
	uint32 fps = 0;
